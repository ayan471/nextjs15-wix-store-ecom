...
import { useCreateBackinNotificationRequest } from "@/hooks/back-in-stock";
import { z } from "zod";
...
export default function BackInStockNotificationButton({
  ...
  const mutation = useCreateBackinNotificationRequest();
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button {...props}>Notiy when available</Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
